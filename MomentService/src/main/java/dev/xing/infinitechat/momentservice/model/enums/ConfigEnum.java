...
public enum ConfigEnum {
    ...
    IMAGE_URI("imageUri","http://localhost:9000/infinitec-chat/"),
    ...
    MINIO_SERVER_URL("minioServerUrl","http://localhost:9000"),
    MINIO_ACCESS_KEY("minioAccessKey", System.getenv().getOrDefault("MINIO_ACCESS_KEY", "change-me")),
    MINIO_SECRET_KEY("minioSecretKey", System.getenv().getOrDefault("MINIO_SECRET_KEY", "change-me")),
